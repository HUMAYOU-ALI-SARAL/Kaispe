    ...
    const cardData = [
        {
            ...
            title: "KAISPE's Vendor Portal Now Available On Microsoft AppSource",
            description: "New York, NY, USA — September 6, 2024 — KAISPE, a leading business software and technology services provider and Microsoft Gold Partner, today announced the availability of their Vendor Portal on Microsoft AppSource, an online cloud marketplace providing tailored line-of-business solutions."
        },
        {
            link: "#",
        ...
        },
        {
            ...
            title: "KAISPE Apps Now Available On AWS Marketplace – Opening New Avenues For Businesses",
            description: "With the technology advancing every day, the need for easy integration and cloud-driven solutions is necessary to be a part of any organization. To help you with the transformative journey, the KAISPE proudly announces the integration of its transformative suite of applications on the renowned AWS Marketplace. This strategic collaboration brings new possibilities for businesses seeking seamless, efficient, and cutting-edge solutions within the dynamic Amazon Web Services (AWS) ecosystem."
        },
        {
            link: "#",
            ...
            title: "KAISPE Customer Portal Now Available In The Microsoft Azure Marketplace",
            description: "NEW YORK, NY, USA — May 22, 2023 — KAISPE, a leading technology solutions provider and Microsoft Gold Partner, today announced the availability of its Customer Portal in the Microsoft Azure Marketplace, an online store providing applications and services for use on Azure. KAISPE customers can now take advantage of the productive and trusted Azure cloud platform, with streamlined deployment and management."
        },
        {
            link: "#",
            ...
            title: "KAISPE Expands To Chicago, IL | Expanding The Reach For Midwest Organizations",
            description: "After New York, with the launch of its second office in Chicago, Illinois, KAISPE, the top provider of technology solutions, has increased the scope of its offerings in the country. KAISPE assists its customers in integrating their devices and processes with their sophisticated business systems, such as CRM and ERPs, thanks to long-standing cooperation in Microsoft and Oracle technology."
        },
        {
            link: "#",
            ...
            title: "KAISPE And Crayon Join Forces To Revolutionize The Way Businesses Tackle Their Problems",
            description: "NEW YORK, May 08, 2023 — We are excited to announce that KAISPE and Crayon join forces for a mutual venture. This partnership made to help organizations of all sizes get access to the cutting-edge KAISPE software solutions. It will streamline their operations and boost their bottom line."
        },
        {
            link: "#",
            ...
            description: "NEW YORK, February 22, 2023 — KAISPE today announced the availability of KPoD on Microsoft Azure Marketplace, as a Transactable solution that provides immediate operational and commercial benefits for Customers and Cloud Service Providers ('CSP's) buying through Microsoft Marketplace."
        },
        {
            link: "#",
            ...
            title: "KAISPE Delivers Oracle NetSuite GoLive!",
